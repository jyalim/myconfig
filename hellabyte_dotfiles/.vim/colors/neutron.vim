...
hi Cursor       guibg=#809080 guifg=#404040
hi ColorColumn  guibg=#e8e5d0 guifg=#808080 gui=none
hi CursorColumn guibg=#e0e0e0 guifg=#202020
hi CursorLine   guibg=#e0e0e0 guifg=#202020
hi NonText      guibg=#f2efd5 guifg=#606060 gui=none
hi Visual       guibg=#a0a0a0 guifg=#404040 gui=none
