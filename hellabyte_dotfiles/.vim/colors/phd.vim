...
let s:bg = '#061229'
let s:bg_hl_soft = '#2f8e99'
let s:bg_hl_lite = '#081733'
let s:bg_hl = '#324454'
...
if version >= 700
  ...
  exe 'hi ColorColumn   guibg='.s:bg_hl_lite     .' gui=none'
...
exe 'hi Visual guifg='.s:text_hl           .' guibg='.s:bg_hl_soft
...
hi Search guifg=#000000 guibg=#d0d000 gui=none
hi IncSearch guifg=#000000 guibg=#c5c500 gui=none

hi Directory guifg=#dad085 gui=NONE
hi Error guibg=#602020

set guicursor=a:hor04-Cursor
" Plugins
